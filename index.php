...
<body id="pakarayam" class="hold-transition skin-red-light sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      <!-- Logo -->
      <a href="./" class="logo" style="background-color: #ffc0c0; color: white;">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b><i aria-hidden="true"></i></b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b><i class="fa facontao" aria-hidden="true"></i>Pakar Mawar</b></span>
      </a>
      <!-- Header Navbar -->
      <nav class="navbar navbar-static-top" role="navigation" style="background-color: #ffc0c0; color: white;">
            ...
            ?>
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <div class="pull-mid" style="display: flex; justify-content: center;">
